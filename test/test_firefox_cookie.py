...
COOKIE_DB = "{home}/.mozilla/firefox/f3xb7t8k.default/cookies.sqlite".format(home=os.path.expanduser('~'))
CONTENTS = "host, path, isSecure, expiry, name, value"
COOKIEFILE = 'cookies.lwp'          # the path and filename that you want to use to save your cookies in
URL = 'https://twitter.com/NBA/following'
...
def main():
    ...
    page = get_page_with_cookies(cj)
    with open('page', 'w') as f:
        print >> f, page
    user_list = re.findall('data-user-id="[0-9]+"', page)
